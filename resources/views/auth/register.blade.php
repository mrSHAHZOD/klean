            ...
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
                <div class="panel border bg-white">
                    <div class="panel-heading">
                        <h3 class="pt-3 font-weight-bold">Royxatdan Otish</h3>
                    </div>
                    <div class="panel-body p-3">
                        <form action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-group py-1 pb-2">
                                <div class="input-field">
                                    <span class="fas fa-lock px-2"> </span>
                                <input type="password" name="password_confirmation"  placeholder="Parol tasdiqlang" required>
                                 </div>
                            </div>

                            <button type="submit" class="btn btn-primary btn-block mt-3">Jonatish</button>
                            <div class="text-center pt-4 text-muted">Royxatdan Otganmisiz?
                                <a href="{{ route('login') }}">Ro`yxatdano`tish</a>
